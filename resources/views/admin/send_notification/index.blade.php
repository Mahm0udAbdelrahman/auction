                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger delete-country-btn" data-id="{{ $notification->id }}">
                                                <i class="far fa-trash-alt"></i>
                                            </button>
                                            @endcan

                                            @can('send_notifications-update')
                                            <a href="{{ route('Admin.send_notifications.edit',$notification) }}" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @empty
