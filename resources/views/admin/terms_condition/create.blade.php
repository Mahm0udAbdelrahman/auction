...
@section('title', __('Add Terms and Conditions Policy'))
        ...
        <div class="main-content">
            <div class="row mb-5">
                <div class="col-12 col-xl-12">
                    <form method="post" action="{{ route('Admin.terms_condition.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h6>{{ __(key: 'Add Terms and Conditions Policy') }}</h6>
                                </div>
                                <hr>
                                <div class="row">
