                    ...
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table id="example2" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('users-delete')
                                                <button type="button" onclick="deleteId({{ $user->id }})" class="btn btn-danger"><i class="far fa-trash-alt"></i></button>
                                            @endcan
                                            @can('users-update')
                                            <a href="{{ route('Admin.users.edit',$user) }}" class="btn btn-info "><i class="fas fa-edit"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                    @empty
                            ...
                            <div style="padding:5px;direction: ltr;">
                                {!! $buyers->withQueryString()->links('pagination::bootstrap-5') !!}
                            </div>
                        </div>
                    </div>
                </div>
