...
@section('title', __('Add Privacy Policy'))
        ...
        <div class="main-content">
            <div class="row mb-5">
                <div class="col-12 col-xl-12">
                    <form method="post" action="{{ route('Admin.privacy_policy.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h6>{{ __(key: 'Add Privacy Policy') }}</h6>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-6 col-xl-6 mb-3">
                                        <input type="text" name="message_ar" class="form-control"
                                            placeholder="{{ __('Enter Privacy Policy Arabic') }}">
                                    </div>

                                    <div class="col-6 col-xl-6 mb-3">
                                        <input type="text" name="message_en" class="form-control"
                                            placeholder="{{ __('Enter Privacy Policy English') }}">
                                    </div>

                                    <div class="col-6 col-xl-6 mb-3">
                                        <input type="text" name="message_ru" class="form-control"
                                            placeholder="{{ __('Enter Privacy Policy Russian') }}">
                                    </div>
