                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-xl-6 mb-3">
                                    <input type="number" name="phone" value="{{ $maintenance_center->phone }}" class="form-control" placeholder="{{ __('Enter Phone') }}">
                                </div>
                                <div class="col-6 col-xl-6 mb-3">
                                    <input type="text" name="location" value="{{ $maintenance_center->location }}" class="form-control" placeholder="{{ __('Enter Location') }}">
                                </div>
                            </div>
                        </div>
                    </div>
