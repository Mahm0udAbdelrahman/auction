    ...
    <section class="login-page choose-service">
      <div class="container">
        ...
        <div class="row py-5 mt-4">
          ...
          <div
            class="col-12 col-md-6 mx-auto d-flex flex-column align-items-center mt-4"
          >
            <form class="w-100">
              <div class="d-flex justify-content-between gap-3">
                ...
                <div class="card position-relative flex-grow-1 bg-light">
                  ...
                  <label for="sell-car" class="card-body text-center">
                    <img
                      src="{{ asset('web/assets/Images/403019_avatar_male_man_person_user_icon 1.png')}}"
                      alt="Buy Icon"
                      class="mb-3"
                    />
                    <p class="mb-0">سياره خاصه لي</p>
                  </label>
                </div>
                ...
                <div class="card position-relative flex-grow-1 bg-light">
                  ...
                  <label for="buy-car" class="card-body text-center">
                    <img
                      src="{{ asset('web/assets/Images/403022_business man_male_user_avatar_profile_icon 1.png')}}"
                      alt="Buy Icon"
                      class="mb-3"
                    />
                    <p class="mb-0">انا تاجر سيارات</p>
                  </label>
                </div>
              </div>
              <a
